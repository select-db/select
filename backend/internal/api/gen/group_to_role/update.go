...
// updateBodySchema is the request-body contract PATCH /group_to_roles/{id} validates
...
// Update handles PATCH /group_to_roles/{id}: apply the request body to an existing
