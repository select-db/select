...
import (
	...
	syncpermission "selectDb/backend/db/syncer/permission"
	syncrole "selectDb/backend/db/syncer/role"
	syncuser "selectDb/backend/db/syncer/user"
	syncutr "selectDb/backend/db/syncer/user_to_role"
	syncworkspace "selectDb/backend/db/syncer/workspace"
	syncwtu "selectDb/backend/db/syncer/workspace_to_user"
	"selectDb/backend/git"
