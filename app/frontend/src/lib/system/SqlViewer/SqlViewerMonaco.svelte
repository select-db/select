<script lang="ts">
	// Before monaco, which reads MonacoEnvironment as it loads. The editor used to
	// be in the bundle whatever happened, so this came along with it; now that both
	// are behind a dynamic import, whichever loads first has to bring it.
	import '$lib/components/views/File/Editor/config/monacoWorkers';
